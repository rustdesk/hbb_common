...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.yesapart".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("YES Desk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["desk.yesapart.com"];
pub const RS_PUB_KEY: &str = "xgGBoobByOh1E0xkSj3T7gTHBiUhOHixTWOD7ojF6K4=";
