...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("alieismy.cc:21116".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["alieismy.cc:21116"];
pub const RS_PUB_KEY: &str = "xQSA3rR7Fch1Ou4iKUPyJGaCUtPbIzMuoTEAFUv4mX8=";
