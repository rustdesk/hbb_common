...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.pnslai.com.ph"];
pub const API_SERVER: &str = "https://rustdesk.pnslai.com.ph";
pub const RS_PUB_KEY: &str = "v8k2QV0cwT6DeyOVzwgyZ9tkt064BLmPWNbA54rj97s=";
