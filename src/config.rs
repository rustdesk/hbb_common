...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("GrainDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["93.95.171.91"];
pub const RS_PUB_KEY: &str = "T7osR/7rXRXlXriB3wBEqV11Gg0yv0/Q3YUQQvCNebY=";
