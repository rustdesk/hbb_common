...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk do Diorgera".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.diorg.es"];
pub const RS_PUB_KEY: &str = "9rewKHid2smw7DRvJMyfMnOpiTaRaC6x7V2CCOR92s0=";
